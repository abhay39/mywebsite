...
const Websites = () => {
  return (
    ...
    <div className=' w-full md:w-1/2 '>
            ...
            <h1 className='text-3xl text-red-400 font-bold'>Hotel Booking Website</h1>
            <span className=' text-base opacity-70 text-justify'><span className=' font-bold'>Domain:</span> MERN Stack, Website</span>
            <br />
            <span className=' text-base opacity-70 text-justify'><span className=' font-bold'>Programming Language:</span> Next.js, JavaScript, MongoDB, Node.js, Express.
            </span>
            <br />
            <br />
    ...
    <div className=' w-full md:w-1/2 '>
            ...
            <h1 className='text-3xl text-red-400 font-bold'>E-Commerce Website</h1>
